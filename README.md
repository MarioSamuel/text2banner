...
3. Find the Windows version of the app. Often, this will be a file ending in `.exe` or `.zip`.
...
7. When the app opens, type the text you want to turn into a banner.

8. Choose your preferred font style from the options.

9. Copy the generated banner by selecting it and pressing Ctrl+C or by clicking a copy button if available.

10. Paste it into the place you want, like a README file or terminal.
...
- Save your banners in `.txt` files if you want to reuse them later.

---

## 🔄 Updating text2banner

New versions may add more fonts or improve performance. To update:

1. Visit the releases page again.  
2. Download the newest Windows file as before.  
3. Replace the old version with the new one by running the latest downloaded app.
...
- Try running the `.exe` file as an administrator (right-click > Run as administrator).
